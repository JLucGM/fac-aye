...
export const columns: ColumnDef<any>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const handleDelete = () => {
        destroy(route('user.destroy', [row.original.slug ?? row.original.id]), {
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem asChild>
                <Link className={buttonVariants({ variant: 'ghost' }) + ' w-full justify-start'} href={route('user.edit', [row.original.slug ?? row.original.id])} >
