...
export const columns: ColumnDef<PaymentMethod>[] = [
  ...
  },
  {
    ...
    cell: ({ row }) => {
      ...
      const handleDelete = () => {
        destroy(route('payment-methods.destroy', [row.original.slug ?? row.original.id]), {
          ...
          <Dialog open={showDeleteDialog} onOpenChange={setShowDeleteDialog}>
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  Esta acción eliminará permanentemente el método de pago **{row.original.name}**. Esta acción no se puede deshacer.
                </DialogDescription>
              </DialogHeader>
              <DialogFooter className="gap-2">
                ...
                <Button
                  ...
                  disabled={processing}
                >
                  {processing ? "Eliminando..." : "Eliminar Método"}
                </Button>
              </DialogFooter>
            </DialogContent>
          </Dialog>
